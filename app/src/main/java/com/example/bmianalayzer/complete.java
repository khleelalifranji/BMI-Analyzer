...
public class complete extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    public void minLength(View view) {
        if (!length.getText().toString().equals("179")) {
            countL--;
            length.setText(countL + "");
        }
    }
    ...
    public void minWei(View view) {
        if (weight.getText().toString().equals("92")) {
            Toast.makeText(getApplicationContext(), "Enter a value greater than 50", Toast.LENGTH_SHORT).show();
        } else {
            countW--;
    ...
    public void save(View view) {
        ...
        if (birthday.getText().toString().equals("")) {
            Toast.makeText(getApplicationContext(), "add birthday", Toast.LENGTH_SHORT).show();
            return;
        }
